...
void Output::DrawCardNumber(const CellPosition& cellPos, int cardNum) const
{
	...
	///TODO: Calculate the Width & Height of the integer "cardNum" if written using the Current Font6.
...
void Output::CreateDesignModeToolBar() const
{
	...
	MenuItemImages[ITM_COPY_CARD] = "images\\Menu_Copy Card.jpg";
	MenuItemImages[ITM_CUT_CARD] = "images\\Menu_Cut Card.jpg";
	MenuItemImages[ITM_PASTE_CARD] = "images\\Menu_Paste Card.jpg";
	MenuItemImages[ITM_EDIT_CARD] =  "images\\Menu_Edit Card.jpg";
	MenuItemImages[ITM_SAVE_GRID] = "images\\Menu_Save Grid.jpg";
	MenuItemImages[ITM_OPEN_GRID] = "images\\Menu_Open Grid.jpg";
	MenuItemImages[ITM_DELETE_GAME_OBJECT] = "images\\Menu_Delete Object.jpg";
...
void Output::PrintPlayersInfo(string info)
{
	...
	pWind->SetPen(UI.ToolBarColor, 1);
	pWind->SetBrush(UI.ToolBarColor);
	pWind->DrawRectangle(5 * UI.MenuItemWidth, 0, UI.width, UI.ToolBarHeight);
...
void Output::DrawLadder(const CellPosition& fromCell, const CellPosition& toCell) const
{
	...
	///TODO: Draw The First Vertical Line (The Left Lined) in the appropriate coordinates
	...
	int y = fromStartY;
	for (int i = 0 ; i <( -toCell.VCell() + fromCell.VCell()); ++i)
	{
