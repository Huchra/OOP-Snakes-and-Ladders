...
{
	checkCellDrawing = true; // checkCellDrawing intilizes with true
...
{	
	...
	pOut->PrintMessage("New Card: Click to continue ...");
	int x,y;
	...
	{
	   pGrid ->PrintErrorMessage(" The cardNumber can't be greater than 14 or less than 1 ! Click to continue ...");
	   pOut->ClearStatusBar();
	   checkCellDrawing = false;
		return;
	}
	...
	{
	   pGrid ->PrintErrorMessage(" Cell can’t have more than one card! Click to continue ...");
	   pOut->ClearStatusBar();
	   checkCellDrawing = false;
		return;
	}
